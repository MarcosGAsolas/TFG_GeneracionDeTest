...
\noindent\includegraphics[width=\textwidth]{cabecera}\vspace{1cm}%
  ...
  {%
    ...
    Tutor: \@tutor{Pedro Renedo Fernandez}\\
  }%
  \end{center}%
  \null
  \cleardoublepage
...
\newcommand{\nombre}{Marcos Guzmán Asolas} %%% cambio de comando
\newcommand{\nombreTutor}{Pedro Renedo Fernandez} %%% cambio de comando

% Datos de portada
\title{Generador De Test Unitarios}
\author{\nombre}
\tutor{}
\date{\today}
...
\noindent Que el alumno D. \nombre, con DNI 06289561G, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado título de TFG. 
